...
Defines the interface for screenshot capture, processing, and transmission.
This contract ensures consistent behavior across all screenshot-related operations.
"""
...
from entities import Screenshot, CaptureRegion, PrivacyZone
